...
const AnswersContainer = ({ idPage }: Props) => {
  ...
  switch (idPage) {
    case "typescript":
      ...
      answer = "El ventaja principal de Typescript es que te permite de gestionar los types de la Single Page Application. Entonces cuando desarrollamos nuestra aplicación es mas facil tambien porquè Typescript sugiere (cuando escribemos el codigo) el tipo correspondiente (CTRL + Espacio, in Visual studio code). Asimismo Typescript reporte mas fácilmente los errores en el nuestro IDE, y se puede usar con Angular y Vue.js tambien. Como desventajas alguien puede preferir alternativas mas flexibles (como prop-types por ejemplo).";
      break;
    case "redux":
